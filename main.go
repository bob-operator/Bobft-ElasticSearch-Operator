...
import (
	...
	"Bobft-ElasticSearch-Operator/controllers"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "1b8cd0bf.bobfintech.com",
	})
	if err != nil {
	...
	if err = (&controllers.ElasticsearchStatusReconciler{
		Client: mgr.GetClient(),
		Scheme: mgr.GetScheme(),
	}).SetupWithManager(mgr); err != nil {
		setupLog.Error(err, "unable to create controller", "controller", "ElasticsearchStatus")
		os.Exit(1)
	}
